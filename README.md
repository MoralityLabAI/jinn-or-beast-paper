...
| exp:3 frame internalization SFT | `ConstitutionalAlignment/experiments/frame_internalization_sft_v1/` | INTERRUPTED, payloads lost; recovered rerun protocol drafted (not frozen, not run). Present registered-report style. |
...
| Jinn/Beast multi-agent storyworlds | `Pixieology/experiments/jinn_beast_multiagent_storyworlds/` | Plumbing + live dyad PASS; frame signal not yet established; nothing adapter-eligible. |
